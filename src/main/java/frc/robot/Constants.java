...
public final class Constants {
  ...
  public static class ShooterConstants{
    ...
    public static final double speakerTopMotorSpeed = 5700*0.4; 
    public static final double speakerBottomMotorSpeed = 5700*0.4; 
    ...
    //  public static final double speakerTopMotorSpeed = 5700*1.0; 
    // public static final double speakerBottomMotorSpeed = 5700*0.5; 
    ...
    public static final double ampBottomMotorSpeed = 5700 * 0.45; 
  ...
  public static class VisionConstants{
    ...
    public static final double roughAlignmentTolerance = 3.5; 
    public static final double fineAlighnmentTolerance = 2.5; 

    public static final double desiredApproachDistance = 40; 

    public static final double limelightTurnSpeedLimit = 0.5; 
  }
  ...
  public static class photonVisionConstants{
    ...
    public static int speakerMiddleRedID = 3;
    public static int speakerOffCentreRedID = 4;
