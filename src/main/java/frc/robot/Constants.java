...
public final class Constants {
  ...
  public static class photonVisionConstants{
    ...
    public static double turnKp = 0.035; 
  ...
  public static class LedConstants{
    ...
    public static final int[] orangeColourCode = {255, 165, 0}; 
