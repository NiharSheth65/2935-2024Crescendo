...
public final class Constants {
  ...
  public static class DriveConstants{
    ...
    public static final double autoDriveLimelightSpeed = 0.60; 
  }
  ...
  public static class ShooterConstants{
    ...
    public static final double speakerTopMotorSpeed = -5700*0.25; 
    public static final double speakerBottomMotorSpeed = 5700*0.25; 
  ...
  public static class VisionConstants{
    ...
    public static final double desiredApproachDistance = 35; 
