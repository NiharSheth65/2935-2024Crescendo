  ...
  private void configureBindings() {
    ...
    BUTTON_A_PRIMARY.onTrue(
      new ParallelRaceGroup(
        ...
        // new autoDigestNoteCommand(m_IntakeSubsystem, m_ShooterSubsystem, m_ConveyerSubsystem)
    ...
    BUTTON_B_PRIMARY.onTrue(
      new ParallelRaceGroup(
        ...
        new autoShootNoteCommand(m_DriveSubsystem, m_PhotonvisionSubsystem, m_LightSubsystem, m_ShooterSubsystem, m_ConveyerSubsystem)
      )
    ); 
