...
public class note2Block extends SequentialCommandGroup {
  ...
  public note2Block(DriveSubsystem drive, VisionSubsystem vision, PhotonvisionSubsystem photon, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, TruckLightSubsystem truck) {
    ...
    addCommands(
      ...
      new ParallelDeadlineGroup(
        ...
        new SequentialCommandGroup(
          ...
          // new driveStopForTimeCommand(drive, 500),
