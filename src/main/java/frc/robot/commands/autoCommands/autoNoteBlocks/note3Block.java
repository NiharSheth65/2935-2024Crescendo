...
public class note3Block extends SequentialCommandGroup {
  ...
  public note3Block(DriveSubsystem drive, VisionSubsystem vision, PhotonvisionSubsystem photon, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, LightSubsystem led, TruckLightSubsystem truck) {
