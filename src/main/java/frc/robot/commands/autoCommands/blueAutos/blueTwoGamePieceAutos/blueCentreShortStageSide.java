...
public class blueCentreShortStageSide extends SequentialCommandGroup {
  /** Creates a new blueCentreShortStageSide. */
  public blueCentreShortStageSide(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        ...
        new SequentialCommandGroup(
          ...
          new ParallelDeadlineGroup(
            new autoDriveForwardSetDistance(drive, DriveConstants.autoDriveForwardAndIntakeDistance, 0.6),
            new IntakeCommand(intake, IntakeConstants.intakeSpeed), 
            new ConveyerIntakeTillThirdSensor(conveyer)
          ), 

          // turn backward to face april tag 
          new autoTurnCommand(drive, -65, false), 

          // drive up and run conveyer 
          new ParallelDeadlineGroup(
            new ParallelCommandGroup(
              new autoDriveForwardSetDistance(drive, -35, 0.60), 
              new ConveyerIntakeTillThirdSensor(conveyer)
            ),  
      ...
      //   new ParallelDeadlineGroup(
      //     new ParallelCommandGroup(
      //       new autoDriveForwardSetDistance(drive, -45, 0.60), 
      //       new ConveyerIntakeTillThirdSensor(conveyer)
      //     ),  
