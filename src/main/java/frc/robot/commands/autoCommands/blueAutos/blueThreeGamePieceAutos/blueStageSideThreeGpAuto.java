...
public class blueStageSideThreeGpAuto extends SequentialCommandGroup {
  ...
  public blueStageSideThreeGpAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter) {
    ...
    addCommands(
      ...
      new visionTurnCommand(drive, vision, 0, false, VisionConstants.roughAlignmentTolerance)
        ...
        .andThen(
          new autoTurnForTime(drive, 300, DriveConstants.rightDirection)
        )
