...
public class blueCentreTwoGPAuto extends SequentialCommandGroup {
  /** Creates a new blueCentreTwoPieceAuto. */
  public blueCentreTwoGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck, LightSubsystem led) {
