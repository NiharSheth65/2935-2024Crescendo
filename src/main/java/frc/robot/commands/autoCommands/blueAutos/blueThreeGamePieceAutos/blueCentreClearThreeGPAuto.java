...
public class blueCentreClearThreeGPAuto extends SequentialCommandGroup {
  /** Creates a new blueCentreClearThreeGPAuto. */
  public blueCentreClearThreeGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck, LightSubsystem led) {
