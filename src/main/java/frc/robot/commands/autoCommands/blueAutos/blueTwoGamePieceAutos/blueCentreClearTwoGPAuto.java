...
public class blueCentreClearTwoGPAuto extends SequentialCommandGroup {
  ...
  public blueCentreClearTwoGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck) {
