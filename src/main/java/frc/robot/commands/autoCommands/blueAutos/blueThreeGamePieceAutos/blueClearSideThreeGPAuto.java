...
public class blueClearSideThreeGPAuto extends SequentialCommandGroup {
  /** Creates a new blueClearSideThreeGPAuto. */
  public blueClearSideThreeGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter) {
    ...
    addCommands(
      ...
      new visionTurnCommand(drive, vision, 0, false, VisionConstants.roughAlignmentTolerance)
        ...
        .andThen(
          new autoTurnForTime(drive, 300, DriveConstants.leftDirection)
        )
