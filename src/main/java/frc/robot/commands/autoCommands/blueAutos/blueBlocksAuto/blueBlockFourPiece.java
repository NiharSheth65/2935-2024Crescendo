...
package frc.robot.commands.autoCommands.blueAutos.blueBlocksAuto;
...
public class blueBlockFourPiece extends SequentialCommandGroup {
  /** Creates a new blueBlockFourPiece. */
  public blueBlockFourPiece(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck, LightSubsystem led) {
