...
public class blueStageSideTwoGPAuto extends SequentialCommandGroup {
  /** Creates a new blueStageSideTwoGPAuto. */
  public blueStageSideTwoGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter) {
