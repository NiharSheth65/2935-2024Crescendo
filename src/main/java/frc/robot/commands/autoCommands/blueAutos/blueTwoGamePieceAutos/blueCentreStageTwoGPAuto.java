...
public class blueCentreStageTwoGPAuto extends SequentialCommandGroup {
  /** Creates a new blueCentreStageTwoGPAuto. */
  public blueCentreStageTwoGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck, LightSubsystem led) {
