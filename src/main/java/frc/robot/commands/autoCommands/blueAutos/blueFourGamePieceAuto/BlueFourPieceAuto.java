...
public class BlueFourPieceAuto extends SequentialCommandGroup {
  /** Creates a new BlueFourPieceAuto. */
  public BlueFourPieceAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon) {
      ...
      // NOTE 4 *********************
       ...
       new ParallelRaceGroup(
        ...
        new SequentialCommandGroup(
          ...
          new autoDriveForwardSetDistance(drive, 24, 0.6),
