...
public class BlueFourPieceAuto extends SequentialCommandGroup {
  ...
  public BlueFourPieceAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        ...
        new SequentialCommandGroup(
          ...
          new ParallelDeadlineGroup(
            new ParallelCommandGroup(
              new autoDriveForwardSetDistance(drive, -35, 0.5), 
              new ConveyerIntakeTillThirdSensor(conveyer)
            ),  
          ...
          // run intake and shooter
            ...
            new SequentialCommandGroup(
              new autoDriveForwardSetDistance(drive, -40, 0.5), 
              new conveyerTillSensorCleared(conveyer)
            )
          )
       ...
       new ParallelRaceGroup(
        ...
        new SequentialCommandGroup(
          ...
          new ParallelDeadlineGroup(
            ...
            new autoDriveForwardSetDistance(drive, -35, 0.5),
            new photonVisionDriveAndAlignCommand(photon, drive, 0, 0, false, photonVisionConstants.speakerMiddleBlueID), 
            new autoDriveForwardSetDistance(drive, -25, 0.6), 
            new conveyerTillSensorCleared(conveyer)
        )
      ) 
    );
