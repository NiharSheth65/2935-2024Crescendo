...
// public class blueClearSideExitWingThreeGPAuto extends SequentialCommandGroup {
//   /** Creates a new blueClearSideExitWingThreeGPAuto. */
//   public blueClearSideExitWingThreeGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter) {
...
//       new visionTurnCommand(drive, vision, 0, false, VisionConstants.roughAlignmentTolerance)
//         .andThen(new visionDriveCommand(drive, vision, false, 0, VisionConstants.desiredApproachDistance))
//         .andThen(new visionTurnCommand(drive, vision, 0, false, VisionConstants.fineAlighnmentTolerance))
...
//             new shooterTimeCommand(shooter, ShooterConstants.speakerTopMotorSpeed, ShooterConstants.speakerBottomMotorSpeed, 1500), 
//             new intakeTimeCommand(intake, 0, 1000, 1000), 
//             new autoDriveForwardSetDistance(drive, -30, 0.60)
//           ) 
//         )

//         .andThen(new autoDriveForwardSetDistance(drive, 100, 0.60))
//         .andThen(new autoTurnForTime(null, 100, DriveConstants.rightDirection))
//         .andThen(new autoDriveForwardSetDistance(drive, 100, 0.60))
