...
public class redCentreClearTwoGPAuto extends SequentialCommandGroup {
  ...
  public redCentreClearTwoGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck) {
