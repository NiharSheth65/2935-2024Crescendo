...
public class redCentreStageTwoGPAuto extends SequentialCommandGroup {
  ...
  public redCentreStageTwoGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck) {
