...
public class redClearThreeGPAuto extends SequentialCommandGroup {
  /** Creates a new redClearThreeGPAuto. */
  public redClearThreeGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck) {
