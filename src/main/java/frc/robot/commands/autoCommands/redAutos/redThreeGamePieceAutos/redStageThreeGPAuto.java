...
public class redStageThreeGPAuto extends SequentialCommandGroup {
  /** Creates a new redStageThreeGPPieceAuto. */
  public redStageThreeGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck) {
    ...
    new ParallelRaceGroup(
      ...
      new ParallelRaceGroup(
        ...
        new SequentialCommandGroup(
          ...
          new ParallelDeadlineGroup(
            new ParallelCommandGroup(
              new autoDriveForwardSetDistance(drive, -50, 0.5), 
              new ConveyerIntakeTillThirdSensor(conveyer)
            ),  
