...
public class redCentreStageThreeGPAuto extends SequentialCommandGroup {
  ...
  public redCentreStageThreeGPAuto(DriveSubsystem drive, VisionSubsystem vision, IntakeSubsystem intake, ShooterSubsystem shooter, ConveyerSubsystem conveyer, PhotonvisionSubsystem photon, TruckLightSubsystem truck) {
