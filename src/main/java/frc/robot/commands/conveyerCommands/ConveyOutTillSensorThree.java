...
public class ConveyOutTillSensorThree extends Command {
  ...
  /** Creates a new ConveyOutTillSensorThree. */
  public ConveyOutTillSensorThree(ConveyerSubsystem conveyer) {
  ...
  @Override
  public void execute() {
    CONVEYER_SUBSYSTEM.setConveyer(conveyerConstants.conveyerOutSpeed);
  ...
  public boolean isFinished() {
    if(CONVEYER_SUBSYSTEM.intakeSwitchThreeValue() == false){
      return true; 
    }
