...
public class conveyerTillSensorCleared extends Command {
  /** Creates a new conveyerTillSensorCleared. */
  private ConveyerSubsystem CONVEYER_SUBSYSTEM; 

  private double initTime; 


  public conveyerTillSensorCleared(ConveyerSubsystem conveyer) {
  ...
  public boolean isFinished() {
    if(CONVEYER_SUBSYSTEM.intakeSwitchThreeValue() == false && CONVEYER_SUBSYSTEM.intakeSwitchTwoValue() == false && CONVEYER_SUBSYSTEM.intakeSwitchOneValue() == false){
      return true; 
    }
