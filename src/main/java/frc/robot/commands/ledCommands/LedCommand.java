...
public class LedCommand extends Command {
  ...
  public void execute() {
     ...
     if(INTAKE_SUBSYSTEM.hasIntaked() == true || CONVEYER_SUBSYSTEM.intakeSwitchOneValue() == true || CONVEYER_SUBSYSTEM.intakeSwitchTwoValue() == true  || CONVEYER_SUBSYSTEM.intakeSwitchThreeValue() == true){
