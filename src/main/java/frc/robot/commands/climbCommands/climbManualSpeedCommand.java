...
public class climbManualSpeedCommand extends Command {

  private ClimbSubsystem CLIMB_SUBSYSTEM; 
  private double climbSpeed; 


  /** Creates a new climbManualSpeedCommand. */
  public climbManualSpeedCommand(ClimbSubsystem climb, double speed) {
